...
ls -a git-test-clone
```
생성된 git-test-clone 폴더 확인<br>
<img width="700" title="" src="git_images/gh2-04-image.png">
<br><br>

소스트리에서 git-test-clone 확인 후 더블클릭 실행<br>
...
연결된 git-test-clone 폴더에 README.md 파일 생성<br>
...
원격 저장소에 보낼 파일 선택 후 push 버튼 클릭<br>
<img width="700" title="" src="git_images/gh2-11-image.png"><br>

전송 완료 후 [origin/main] 추가 된 것을 확인할 수 있다. <br> 
<img width="700" title="" src="git_images/gh2-12-image.png"><br>

원격 저장소의 git-test 레파지토리에 전송된 파일을 확인한다.<br>
